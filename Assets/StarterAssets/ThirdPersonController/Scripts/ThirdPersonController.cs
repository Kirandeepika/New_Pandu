...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        [Tooltip("Drag your health bar Image (Fill method) here")]
        ...
        private void Awake()
        {
            ...
            if (_mainCamera == null)
                Debug.LogError("ThirdPersonController: No GameObject with 'MainCamera' tag found!");
        }
        ...
        {
            Health = Mathf.Clamp(Health - amount, 0f, 1f);
            UpdateHealthBar();
